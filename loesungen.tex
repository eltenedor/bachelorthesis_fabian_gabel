...
\begin{proof}
  ...
  Der Raum $W_0^{1,q}(\Omega)$ ist nach Definition ein bezüglich \sobolev\hyp{}Norm abgeschlossener Unterraum von $W^{1,q}(\Omega)$ und als solcher insbesondere vollständig.
