...
\begin{proof}
  ...
  Aus der Funktionentheorie ist bekannt, dass jede auf der zusammenhängenden Menge $\overline\Omega_1$ definierte glatte Abbildung $g \in C^\infty(\overline\Omega_1)^n$ genau dann ein Potential besitzt, falls das Kurvenintegral entlang jeder in $\Omega_1$ verlaufenden glatten Kurve $w \colon [0,1] \to \overline\Omega_1$ verschwindet, also genau dann, falls
  $$
  \oint_w g \cdot \d s = \int_0^1 g(w(\tau))\cdot w'(\tau) \d\tau = 0
  $$
  für alle glatten Kurven $w$ gilt.
  ...
  $$
  und erhalten durch wiederholte Anwendung der \leibniz\hyp{}Regel für Parameterintegrale sofort $ V_{w,\varepsilon} \in C_0^\infty(\Omega_2)^n$
